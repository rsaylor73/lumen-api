...
class CreateV2DeleteDemoServerQueueTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('v2_delete_demo_server_queue', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('v2_delete_demo_server_queue');
    }
}
